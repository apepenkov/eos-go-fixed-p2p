...
### [**0.10.2**](https://github.com/apepenkov/eos-go-fixed-p2p/releases/tag/v0.10.2) (January 19th, 2022)
...
### [**0.10.1**](https://github.com/apepenkov/eos-go-fixed-p2p/releases/tag/v0.10.1) (January 19th, 2022)

#### Breaking Changes

* Renamed [`BlockTimestampFormat`](https://github.com/apepenkov/eos-go-fixed-p2p/blob/a1623cc5a2223005a4dc7d4dec972d6119de42ff/types.go#L844) to `blockTimestampFormat` making it private.
...
### [**0.10**](https://github.com/apepenkov/eos-go-fixed-p2p/releases/tag/v0.10.0) (October 16th, 2021)
